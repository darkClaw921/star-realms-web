...
export const UI = {
  ...
  inPlay: 'В игре',
  logHint: 'Журнал партии: что сделал каждый и что из этого вышло. Esc закрывает.',
  hide: 'Скрыть',
  ...
  soundOnName: 'Звук',
  soundOnDesc: 'Розыгрыш карты, покупка, бой, взрыв базы, конец хода.',
  soundGroup: 'Звук и вспышки',
  soundGroupHint: 'Выключатели действуют сразу и во всех режимах. Если система ' +
    'просит поменьше движения, вспышки выключены независимо от настройки.',
  soundName: 'Громкость',
  soundHint: 'Насколько громко. При выключенном звуке ползунок ничего не меняет — ' +
    'громкость сохраняется до следующего включения.',
  soundOff: 'выкл.',
