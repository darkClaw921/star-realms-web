...
export const UI = {
  ...
  challengesSource: 'Правила взяты из книги правил Star Realms: Frontiers (стр. 21–40) ' +
    ...
    'и оборотных (особые правила). Отличия от коробочной игры отмечены у каждого ' +
    'босса и сводятся к двум: игра только одиночная, а колоды четырёх приключений ' +
    'собраны из базовых карт нужной фракции, потому что карт Frontiers в них нет.',
