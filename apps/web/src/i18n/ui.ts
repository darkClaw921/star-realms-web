...
export const UI = {
  ...
  soundName: 'Громкость',
  soundHint: 'Звук стола: розыгрыш карты, покупка, бой, взрыв базы. ' +
    'Ноль выключает звук полностью — браузер даже не заводит аудиоканал.',
  soundOff: 'выкл.',
  effectsName: 'Вспышки на столе',
  effectsDesc: 'Осколки, свечение союза, тряска при уроне и залп победы.',
  effectsHint: 'Если система просит поменьше движения, эффекты выключены ' +
