...
export const UI = {
  ...
  variantHint: 'Сценарий меняет одно правило на всю партию — для обоих игроков. ' +
    'Из двадцати карт набора «Scenarios» реализованы тринадцать: десять по ' +
    'статьям самого издателя и три (помечены ✻) по вторичным описаниям тех же ' +
    'недель Арены. У оставшихся шести — Border Skirmish, Early Recruitment, ' +
    'Fleeting Opportunities, Picking Sides, Prolonged Conflict, Ready Reserves — ' +
    'текста нет нигде: ни в таблице издателя, ни на сканах, ни в его архиве. ' +
    'Выдумывать правила и называть это Star Realms мы не стали.',
  variantRu: {
    '': 'Без сценария',
