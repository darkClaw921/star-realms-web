...
<h2>Чего в игре нет и почему</h2>
<div class="note">
<strong>Шесть из двадцати карт набора «Scenarios» не реализованы намеренно.</strong>
Это Border&nbsp;Skirmish, Early&nbsp;Recruitment, Fleeting&nbsp;Opportunities,
Picking&nbsp;Sides, Prolonged&nbsp;Conflict и Ready&nbsp;Reserves. Их названия есть в
таблице Card&nbsp;Gallery и в расписаниях Арены — текста правил нет нигде: ни в таблице,
ни на сканах (у издателя выложены только вырезки иллюстраций), ни в его блоге (просмотрен
целиком, 337&nbsp;постов), ни на его страницах и в магазине, ни в вики сообщества, ни на
BoardGameGeek. Остальные тринадцать реализованы: десять — по дословным цитатам из статей
издателя, три — по вторичным описаниям тех же недель Арены, и в интерфейсе они помечены
отдельно. Выдумать шесть правил и назвать это Star&nbsp;Realms было бы подделкой, а не
реализацией: через неделю их уже нельзя было бы отличить от настоящих. Они появятся, как
только появится источник — достаточно фотографий этих шести карт.
</div>
