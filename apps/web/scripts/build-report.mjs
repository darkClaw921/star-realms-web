...
<h2>Командное прохождение</h2>
<p class="lede" style="font-size:15px">Приключения Frontiers проходятся вдвоём, втроём и
вчетвером по сети. Правила команды взяты из книги правил Frontiers &mdash; «Гидра» на стр. 17,
подготовка вызовов и уровни сложности на стр. 21&ndash;23, алгоритм атак босса на стр. 24,
и по странице на каждый из восьми вызовов на стр. 25&ndash;40. Текст всех восьми
негабаритных карт вызовов снят со сканов издателя.</p>

<p class="lede" style="font-size:15px">Книга правил не даёт кооперативу один набор командных
правил. Она даёт три, и какой из них действует &mdash; напечатано на самом вызове:</p>
<dl>
<dt>Гидра &mdash; шесть вызовов из восьми</dt>
<dd>Один общий счёт влияния на всю команду, один общий ход и свободная передача торговли и боя
между союзниками. Колода, рука, сброс и зона игры у каждого свои, поэтому карты союзника
не открывают ваши союзные свойства. Пока у любого игрока команды стоит аванпост, команду
нельзя атаковать, а её обычные базы нельзя ни атаковать, ни выбирать целью.</dd>
<dt>Общий пул &mdash; «Пираты Тёмной звезды»</dt>
<dd>«Влияние у игроков раздельное, и выбывают они по одному. Но ход у них общий, и торговлю
с боем они складывают, как команда Гидры». Защита аванпостом здесь личная: общий щит на
стр. 17 выведен из общего счёта влияния, которого в этом режиме нет.</dd>
<dt>Раздельные ходы &mdash; «Межпространственный ужас»</dt>
<dd>«Игроки ходят по очереди... После хода каждого игрока босс делает свой ход. Свойства и
атаки босса действуют только на того игрока, чей ход только что закончился.» Команды нет
вовсе: своё влияние, свой ход, всё своё.</dd>
</dl>

<p class="lede" style="font-size:15px">Всё, что в правилах написано «на игрока», масштабируется:
влияние босса, общий счёт команды, размер руки босса, счётчик ассимиляции у Автоматонов
(+4 за каждого игрока сверх первого), карты в закрытой стопке Немезиды (по одной на игрока),
и «добор карты» у Нашествия слизней за каждого игрока сверх первого. «Защита Империи»
рассчитана на 1&ndash;3 игроков, остальные семь &mdash; на 1&ndash;4.</p>

<div class="note">
<strong>Кого бьёт босс.</strong> Алгоритм атак со стр. 24 применяется ко всему столу: сначала
добить игрока с наибольшим влиянием, если хватает боя; затем самый крепкий аванпост, затем
самую крепкую базу; остаток &mdash; в игрока с наименьшим влиянием. Ничьи разрешаются
случайно, как и написано, но из посеянного потока внутри состояния &mdash; повтор партии
воспроизводится в точности.
<br><br>
А вот когда свойство карты босса говорит «соперник сбрасывает карту», цель одна. Это тоже
напечатано &mdash; на «Защите Империи»: «в первый раз за ход, когда босс применяет „соперник
сбрасывает карту“, случайно определите, в кого он целит; до конца хода он целит в того же
игрока». Свойства, которые бьют по всем, так и написаны &mdash; вся таблица Немезиды говорит
«каждый игрок», и на обороте её карты это отдельно разъяснено.
</div>

<div class="note">
<strong>Чего в командном режиме нет.</strong> Босс с колодой (Нашествие слизней, Безумие
машины, Защита Империи, Цена свободы) ходит общей оценочной политикой, а не напечатанным
«порядком хода» со своей страницы книги правил. Это отступление старше кооператива &mdash; так
же он ходил и в одиночной игре. Со сканов карт вызовов теперь известен и весь остальной
частный свод: «Реестр активов» Цены свободы, две закрытые колоды Защиты Империи, замены
«вместо сброса босса игрок получает 3 влияния» и «торговля босса становится боем».
Ничего из этого пока не реализовано, и в правилах команды ничего не меняет.
</div>
